...
CREATE TABLE `promociones` (
  ...
  KEY `idx_promo_codigo` (`codigo_descuento`),
...
mysql.exe : ERROR 1046 (3D000) at line 1: No database selected
En línea: 24 Carácter: 7
+ "@ + (& "C:\xampp\mysql\bin\mysql.exe" -u root -e "SHOW CREATE VIEW v ...
+       ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : NotSpecified: (ERROR 1046 (3D0...tabase selected:String) [], RemoteException
